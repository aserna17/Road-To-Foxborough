...
"The East Hall is full of framed pictures of past and present Patriots. To the north is a door leading to the Locker Room."
	Pictures is scenery in EastHallway. 
...
"The West Hall, very similar ot the east, is also covered in photos of Patriots and newspaper headlines. To the north is the locker room.".
	Photos is scenery in WestHallway.
...
"Offensive linemen occupy most of the space on this side of the locker room. On the north wall next to the tunnel is large whiteboard with writing on it. Exits are to the east, west, north, and south.".
	...
	Hey Bro! Let's get this win today and PARTAY!!"
		Whiteboard is scenery in NortheastLR.
		The description is "Just a normal whiteboard. It reads: 
		
		Are you game ready? Things needed for tonight:
			- Jersey
			- Game pants
			- Helmet 
			- Shoulder pads
...
"The north west corner of the locker room aka the Reciever Corner. Exits are to the south, west, east, and north.".
	...
	This is your locker. You'll find most of your things in here, otherwise, try checking the equipment rooms. One more thing... We really need you today. Anything to win ... anything."
		...
		Inside you find your gloves from Juls, jersey and game pants".
			...
			Gloves is a wearable object in NorthwestLR. 
			The description is "Brand new gloves from Julian Edelman. All white with a navy blue trim, the Patriot logo is painted across grip on the palms.".
			Jersey is a wearable object in NorthwestLR.
...
"Rows of floor to ceiling shelves full of shoes. Hundreds of pairs for the team, all different colors for home and away games. Exits are to the west and south.".
	Shoes is a wearable object in Equipmentroom2.
...
Understand "screen" as Metal Door.

Saying psi12.5 is an action applying to nothing. Understand "psi125" or "say psi125" or "psi12point5" or "say psi12point5" as saying psi12.5. 
		
Instead of saying psi12.5:
	say "You uttered the secret passcode. The large white screen swings open to reveal that it is acually a door. A metal door.";
	now the Metal Door is described;
	now the description of Metal Door is "A Metal Door that appeared after you uttered the secret password.";
	now the printed name of Metal Door is "Metal Door";
	now Metal door is unlocked.
[special thanks to Mrs. Kiang for help with this code]
...
"An enormous lecture hall type of room. The team gathers here the week of the game to watch film of the opposing team. Exits are to the east and north".


North of NorthwestLR is Tunnel.
Tunnel is a room. "A long dimly lit tunnel. A bright light shines at the end of it... Gillette Stadium.".
...
An every turn rule:
	if Bill Belichick is visible:
		if the player is wearing helmet and player is wearing jersey and player is wearing shoulder pads and player is wearing pants and player is wearing shoes and player is wearing gloves:
...
"The empty stadium is near dead silent pre-game. The only people around are a few Patiot grounds keepers and security guards. North of your position now, across the field is the tunnel leading to the Falcon's locker room.".


North of GilletteStadium is Falcontunnel.
Falcontunnel is a room. Printed name is "Falcon's Tunnel".
"Just ahead is the Falcon's locker room.".
Dan Quinn is a man in Falcontunnel. "The Falcon's head coach Dan Quinn is waiting in the Falcon's Tunnel.

Hey Partiot!! What do you think you're doing?! Get out of here!!".

An every turn rule:
	if the player is carrying Binder:
